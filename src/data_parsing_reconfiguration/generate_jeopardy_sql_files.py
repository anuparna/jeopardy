...
if __name__ == '__main__':
    ...
    df_player_loc = rc_game_player_loc.generate_sql_statements(game_contestant_df, input_config, output_config, rc)

    # Reconfiguration of questions
    rcq.generate_sql_statements(questions_df, trend_df, final_results_df, df_player_loc, input_config, output_config)